		...
		if ( ! get_option( 'easyteachlms-welcome-' . EASYTEACHLMS_VERSION ) ) {
			...
			<div class="updated notice is-dismissible">
				...
				<ul style="padding-left: 15px;list-style: disc;">
					...
					<li><strike>Ready to enable BuddyPress functionality and manage a group of students? <a href="<?php echo $settings_link; ?>">Start Here</a></strike><br/><strong>Attention:</strong> <i>BuddyPress functionality is being updated to support the upcoming BP 9.0, expect to see an <strong>update in your dashboard by September 15th 2021 bringing back updated BP functionality</strong>.<br/>For more info about BuddyPress 9.0 <a href="https://wptavern.com/buddypress-9-0-scheduled-for-short-development-cycle-to-ship-block-based-widgets-ahead-of-wordpress-5-8" target="_blank" rel="noreferrer noopener">click here</a></i></li>
