    ...
    public function __construct($init = false) {
        if ( true === $init ) {
            ...
            */
            ...
            define( 'EDD_SAMPLE_STORE_URL', 'https://easyteach.local' ); // you should use your own CONSTANT name, and be sure to replace it throughout this file

            // the download ID for the product in Easy Digital Downloads
            define( 'EDD_SAMPLE_ITEM_ID', 49 ); // you should use your own CONSTANT name, and be sure to replace it throughout this file

            // the name of the product in Easy Digital Downloads
            define( 'EDD_SAMPLE_ITEM_NAME', 'EasyTeach LMS' ); // you should use your own CONSTANT name, and be sure to replace it throughout this file
